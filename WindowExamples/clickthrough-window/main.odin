...
/*
	Transparent, Clickthough window:
	Sets up window and makes it layered, transparent clickthrough, and topmost (always on top)
*/
...
main :: proc() {
	...
	window_class := win.WNDCLASSW {
		...
		hInstance = instance,
		lpszClassName = win.L("ClickthroughWindowClass"),		
	}
	...
	window = win.CreateWindowExW(
		dwExStyle = win.WS_EX_LAYERED | win.WS_EX_TRANSPARENT | win.WS_EX_TOPMOST,
		lpClassName = window_class.lpszClassName,
		lpWindowName = win.L("Clickthrough Window"),
