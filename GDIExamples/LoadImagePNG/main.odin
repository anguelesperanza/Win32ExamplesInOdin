...
/*
	...
	This will be done by using Odin's built "core:image", specifically "core:image/png" and
	the load_from_file procedure. This will return our image data.
